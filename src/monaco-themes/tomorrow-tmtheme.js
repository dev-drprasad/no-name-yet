export default {
  ...
  colors: {
    ...
    //"editor.inactiveSelectionBackground": "#d6d6d680",
    //"editor.lineHighlightBorder": "#eeeeee",
    //"editor.rangeHighlightBackground": "#fdff0033",
    //"editor.selectionHighlightBackground": "#ebebeb99",
    ...
    //"editorSuggestWidget.foreground": "#4d4d4c",
  ...
  tokenColors: [
    ...
    },
    {
      name: "Italics",
      scope:
        "emphasis, comment, entity.other.attribute-name, entity.other.attribute-name.html, entity.other.attribute-name.tag.jade, entity.other.attribute-name.tag.pug, markup.italic",
      settings: {
        fontStyle: "italic",
      },
    },
